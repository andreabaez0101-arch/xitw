...
$(document).on('click', '.accept-skin', function(e) {
    $.post('https://xrv2-clothingstore/openBill', JSON.stringify({currentValue: currentValue}));
})

$(document).on('click', '.receipt .buttons .pay_cash', function(e) {
    $.post('https://xrv2-clothingstore/buyClothes', JSON.stringify({price: price, type: "cash"}));
})

$(document).on('click', '.receipt .buttons .pay_bank', function(e) {
    $.post('https://xrv2-clothingstore/buyClothes', JSON.stringify({price: price, type: "bank"}));
})
...
$(document).on('click', '.cancel-skin', function(e) {
    $.post('https://xrv2-clothingstore/cancelClothes');
})

$(document).on('click', '.hands-up', function(e) {
    $.post('https://xrv2-clothingstore/hands_up');
})
                        ...
                        <div class="second-item-bar">
                            <div class="item-option helmet_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="helmet_1-value">${currentValue['helmet_1'].newValue}</span>/<span id="helmet_1-max">${currentValue['helmet_1'].max}</span>
                                    </p>
                                </div>
                            ...
                            <div class="item-option helmet_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="helmet_2-value">${currentValue['helmet_2'].newValue}</span>/<span id="helmet_2-max">${currentValue['helmet_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option mask_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="mask_1-value">${currentValue['mask_1'].newValue}</span>/<span id="mask_1-max">${currentValue['mask_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option mask_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="mask_2-value">${currentValue['mask_2'].newValue}</span>/<span id="mask_2-max">${currentValue['mask_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option tshirt_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="tshirt_1-value">${currentValue['tshirt_1'].newValue}</span>/<span id="tshirt_1-max">${currentValue['tshirt_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option tshirt_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="tshirt_2-value">${currentValue['tshirt_2'].newValue}</span>/<span id="tshirt_2-max">${currentValue['tshirt_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option torso_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="torso_1-value">${currentValue['torso_1'].newValue}</span>/<span id="torso_1-max">${currentValue['torso_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option torso_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="torso_2-value">${currentValue['torso_2'].newValue}</span>/<span id="torso_2-max">${currentValue['torso_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option arms">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="arms-value">${currentValue['arms'].newValue}</span>/<span id="arms-max">${currentValue['arms'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option arms_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="arms_2-value">${currentValue['arms_2'].newValue}</span>/<span id="arms_2-max">${currentValue['arms_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option decals_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="decals_1-value">${currentValue['decals_1'].newValue}</span>/<span id="decals_1-max">${currentValue['decals_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option decals_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="decals_2-value">${currentValue['decals_2'].newValue}</span>/<span id="decals_2-max">${currentValue['decals_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option bproof_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bproof_1-value">${currentValue['bproof_1'].newValue}</span>/<span id="bproof_1-max">${currentValue['bproof_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option bproof_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bproof_2-value">${currentValue['bproof_2'].newValue}</span>/<span id="bproof_2-max">${currentValue['bproof_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option pants_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="pants_1-value">${currentValue['pants_1'].newValue}</span>/<span id="pants_1-max">${currentValue['pants_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option pants_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="pants_2-value">${currentValue['pants_2'].newValue}</span>/<span id="pants_2-max">${currentValue['pants_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option shoes_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="shoes_1-value">${currentValue['shoes_1'].newValue}</span>/<span id="shoes_1-max">${currentValue['shoes_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option shoes_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="shoes_2-value">${currentValue['shoes_2'].newValue}</span>/<span id="shoes_2-max">${currentValue['shoes_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option chain_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="chain_1-value">${currentValue['chain_1'].newValue}</span>/<span id="chain_1-max">${currentValue['chain_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option chain_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="chain_2-value">${currentValue['chain_2'].newValue}</span>/<span id="chain_2-max">${currentValue['chain_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option glasses_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="glasses_1-value">${currentValue['glasses_1'].newValue}</span>/<span id="glasses_1-max">${currentValue['glasses_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option glasses_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="glasses_2-value">${currentValue['glasses_2'].newValue}</span>/<span id="glasses_2-max">${currentValue['glasses_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option watches_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="watches_1-value">${currentValue['watches_1'].newValue}</span>/<span id="watches_1-max">${currentValue['watches_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option watches_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="watches_2-value">${currentValue['watches_2'].newValue}</span>/<span id="watches_2-max">${currentValue['watches_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option bracelets_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bracelets_1-value">${currentValue['bracelets_1'].newValue}</span>/<span id="bracelets_1-max">${currentValue['bracelets_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option bracelets_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bracelets_2-value">${currentValue['bracelets_2'].newValue}</span>/<span id="bracelets_2-max">${currentValue['bracelets_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option ears_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="ears_1-value">${currentValue['ears_1'].newValue}</span>/<span id="ears_1-max">${currentValue['ears_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option ears_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="ears_2-value">${currentValue['ears_2'].newValue}</span>/<span id="ears_2-max">${currentValue['ears_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                        ...
                        <div class="second-item-bar">
                            <div class="item-option bags_1">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bags_1-value">${currentValue['bags_1'].newValue}</span>/<span id="bags_1-max">${currentValue['bags_1'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
                            ...
                            <div class="item-option bags_2">
                                <div class="item-values">
                                    ...
                                    <p class="item-value">
                                        <span id="bags_2-value">${currentValue['bags_2'].newValue}</span>/<span id="bags_2-max">${currentValue['bags_2'].max}</span>
                                    </p>
                                </div>
                                <div class="item-suboptions">
...
function changeCamera(type) {
    $.post('https://xrv2-clothingstore/change_camera', JSON.stringify({type: type}));
}
...
function changeRange(item) {
    ...
    if (result != currentValue[item].newValue) {
        ...
        $.post('https://xrv2-clothingstore/change', JSON.stringify({
            type: item,
            new: Number(result)
        }));
        $(`.${item} .item-subname > span`).html(`${getPrice(item, currentValue[item].newValue)}`);
        $(`#${item}-value`).html(currentValue[item].newValue)
    }
}
...
document.addEventListener('mousemove', function (e) {
    if (holdingRightButton) {
    	if (e.pageX > oldx && e.pageY == oldy) {
            $.post('https://xrv2-clothingstore/upate_camera', JSON.stringify({direction: "right", value: e.pageX - oldx}));
        } 
        if (e.pageX == oldx && e.pageY > oldy) {
            $.post('https://xrv2-clothingstore/upate_camera', JSON.stringify({direction: "bottom", value: e.pageY - oldy}));
        } 
        if (e.pageX == oldx && e.pageY < oldy) {
            $.post('https://xrv2-clothingstore/upate_camera', JSON.stringify({direction: "top", value: oldy - e.pageY}));
        } 
        if (e.pageX < oldx && e.pageY == oldy) {
            $.post('https://xrv2-clothingstore/upate_camera', JSON.stringify({direction: "left", value: oldx - e.pageX}));
        }
        oldx = e.pageX;
        oldy = e.pageY;
    }
...
document.addEventListener("wheel", (e) => {
    ...
    $.post('https://xrv2-clothingstore/update_camera_zoom', JSON.stringify({type: zoom}));
})